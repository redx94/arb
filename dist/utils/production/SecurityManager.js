...
Object.defineProperty(SecurityManager, "circuitBreaker", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: new CircuitBreaker()
});
Object.defineProperty(SecurityManager, "rateLimiter", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: new RateLimiter(parseInt(process.env.RATE_LIMIT_REQUESTS || '5'))
}); // 5 requests/minute
