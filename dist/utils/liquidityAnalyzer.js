...
export class LiquidityAnalyzer {
    constructor(config = {}) {
        Object.defineProperty(this, "MIN_LIQUIDITY_DEPTH", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "WETH_ADDRESS", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    async analyzeLiquidity(tokenAddress, amount, priceData) {
        try {
            // Input validation
    ...
    async getLiquidityDepth(token) {
        try {
            ...
            if (this.provider) {
                try {
                    // Get token contract
                    const tokenContract = new ethers.Contract(token, ['function balanceOf(address) view returns (uint256)'], this.provider);
                    // Get pool balance
    ...
    calculatePriceImpact(amount, liquidityDepth) {
        try {
