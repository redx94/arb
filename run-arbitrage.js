...
var ArbitrageEngineModule = require("./src/utils/arbitrage/arbitrageEngine.js");
var monitoring_ts_1 = require("./src/utils/monitoring.ts");
var ArbitrageEngine = ArbitrageEngineModule.ArbitrageEngine;
var logger = monitoring_ts_1.Logger.getInstance();
var arbitrageEngine = ArbitrageEngine.getInstance();
function main() {
